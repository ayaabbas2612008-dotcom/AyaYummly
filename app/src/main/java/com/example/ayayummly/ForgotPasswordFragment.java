...
public class ForgotPasswordFragment extends Fragment {
    ...
    public void onStart(){
        ...
        etEmail = getView().findViewById(R.id.etEMailForgotP);
        btnReset = getView().findViewById(R.id.btnForgotP);
                ...
                fbs.getAuth().sendPasswordResetEmail(etEmail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(getActivity(), "Failed. Check the email address you entered!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
